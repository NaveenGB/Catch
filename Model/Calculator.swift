...
struct Calculator {
    ...
    mutating func setDigit(_ digit: Numbers) {
    ...
    mutating func setOperation(_ operation: Opreations) {
    ...
    func operationIsHighlighted(_ operation: Opreations) -> Bool {
    ...
    private func canAddDigit(_ digit: Numbers) -> Bool {
